...
Pour qui veut héberger un petit serveur Minecraft vanilla public sans configurer son routeur : Docker s'occupe du serveur, playit.gg de l'accès public.
Testé sur un Raspberry Pi 5 (ARM64), mais rien n'est spécifique au Pi — n'importe quel hôte Docker convient.
